...
<body>
    <div class="wrapper">
        <div class="input">
			<div class="title">
				<h1>Actualización de <strong>Tratamientos</strong></h1>
			</div>
            <form action="procesos/actualizarT.php" method="POST">
				...
				<div class="form-field">
					...
					<input type="text" name="txtdesc" value="<?php echo $ver[2] ?>">
				</div>
				<div class="form-field">
					<label><i class="fa-solid fa-person icon"></i>Duración: </label>
					<input type="text" name="txtduracion" value="<?php echo $ver[3] ?>">
				</div>
				<div class="form-field">
                    <label><i class="fa-solid fa-phone icon"></i>ID Diagnóstico: </label>
                    <input type="number" name="txtdiagnostico" value="<?php echo $ver[4] ?>">
				</div>
				<div class="form-field">
                    <label><i class="fa-solid fa-house-chimney icon"></i>ID Médico: </label>
                    <input type="number" name="txtmedico" value="<?php echo $ver[5] ?>">
				</div>
				<div class="form-field">
                    <label><i class="fa-solid fa-envelope icon"></i>Estado: </label>
                    <input type="text" name="txtestado" value="<?php echo $ver[6] ?>">
				</div>
                <div class="form-field">
                    <label><i class="fa-solid fa-envelope icon"></i>Frecuecia de administración: </label>
                    <input type="text" name="txtfre" value="<?php echo $ver[7] ?>">
				</div>
				<div class="form-field">
					<input type="submit" value="Modificar" name="agregar">
					<a href="tratamientos.php">Regresar</a>
				</div>
            </form>
        </div>
    </div>
