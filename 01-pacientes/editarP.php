    ...
    <div class="wrapper">
        <div class="input">
            ...
            <form action="procesos/actualizarP.php" method="POST">
				...
				<div class="form-field">
                    <label><i class="fa-solid fa-phone icon"></i>Fecha de Nacimiento: </label>
                    <input type="date" name="txtfecha" value="<?php echo $ver[3] ?>">
				</div>
				<div class="form-field">
                    <label><i class="fa-solid fa-house-chimney icon"></i>Género: </label>
                    <input type="text" name="txtgenero" value="<?php echo $ver[4] ?>">
				</div>
				<div class="form-field">
					<label><i class="fa-solid fa-person icon"></i>Teléfono: </label>
                    <input type="number" name="txttelefono" value="<?php echo $ver[5] ?>">
				</div>
				<div class="form-field">
                    <label><i class="fa-solid fa-envelope icon"></i>Dirección: </label>
                    <input type="text" name="txtdireccion" value="<?php echo $ver[6] ?>">
				</div>
                <div class="form-field">
                    <label><i class="fa-solid fa-envelope icon"></i>Tipo de Sangre: </label>
                    <input type="text" name="txtsangre" value="<?php echo $ver[7] ?>">
				</div>
				<div class="form-field">
