...
<body>
    <div class="wrapper">
        <div class="input">
			<div class="title">
				<h1>Actualización de <strong>Pacientes</strong></h1>
			</div>
            <form action="procesos/actualizarM.php" method="POST">
				...
				<div class="form-field">
					<label><i class="fa-solid fa-pencil icon"></i>Apellidos: </label>
					<input type="text" name="txtapellido" value="<?php echo $ver[2] ?>">
				</div>
				<div class="form-field">
                    <label><i class="fa-solid fa-phone icon"></i>Especialidad: </label>
                    <input type="text" name="txtespecialidad" value="<?php echo $ver[3] ?>">
				</div>
				<div class="form-field">
                    <label><i class="fa-solid fa-house-chimney icon"></i>Teléfono: </label>
                    <input type="number" name="txttelefono" value="<?php echo $ver[4] ?>">
				</div>
				<div class="form-field">
					<label><i class="fa-solid fa-person icon"></i>Email: </label>
                    <input type="email" name="txtemail" value="<?php echo $ver[5] ?>">
				</div>
				<div class="form-field">
                    <label><i class="fa-solid fa-envelope icon"></i>Licencia: </label>
                    <input type="text" name="txtlicencia" value="<?php echo $ver[6] ?>">
				</div>
                <div class="form-field">
                    <label><i class="fa-solid fa-envelope icon"></i>Años de experiencia: </label>
                    <input type="number" name="txtexperiencia" value="<?php echo $ver[7] ?>">
				</div>
				<div class="form-field">
					<input type="submit" value="Modificar" name="agregar">
					<a href="medicos.php">Regresar</a>
				</div>
            </form>
        </div>
    </div>
