...
<body>
    <div class="wrapper">
        <div class="input">
            ...
            <form action="procesos/actualizarC.php" method="POST">
				<input type="text" hidden="" value="<?php echo $id ?>" name="id">	
				<div class="form-field">
					<label><i class="fa-solid fa-user icon"></i>Fecha: </label>
					<input type="date" name="txtfecha" value="<?php echo $ver[1]; ?>">
				</div>
				<div class="form-field">
					<label><i class="fa-solid fa-pencil icon"></i>Motivo: </label>
					<input type="text" name="txtmotivo" value="<?php echo $ver[2] ?>">
				</div>
				<div class="form-field">
				...
				<div class="form-field">
					<label><i class="fa-solid fa-person icon"></i>Estado: </label>
                    <input type="text" name="txtestado" value="<?php echo $ver[5] ?>">
				</div>
				<div class="form-field">
                    <label><i class="fa-solid fa-envelope icon"></i>Observaciones: </label>
                    <input type="text" name="txtobservacion" value="<?php echo $ver[6] ?>">
				</div>
                <div class="form-field">
                    <label><i class="fa-solid fa-envelope icon"></i>Sala: </label>
                    <input type="text" name="txtsala" value="<?php echo $ver[7] ?>">
				</div>
				<div class="form-field">
